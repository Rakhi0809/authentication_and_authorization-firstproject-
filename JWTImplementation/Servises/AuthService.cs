...
namespace JWTImplementation.Servises
{
    public class AuthService : IAuthService
    {
        ...
        public string Login(LoginRequest loginRequest)
        {
            ...
            {
                var user = _jwtService.Users.SingleOrDefault(s=> s.Email ==loginRequest.Username && s.Password
                ...
                {
                    throw new ArgumentException("user are not valid");
                }
            }
